  ...
  <div className="app-header">
    ...
    <div className="app-header-right">
      ...
      <button className="profile-btn">
        <img src="/assets/illuminati6.jpg" />
        <span>Aybüke C.</span>
      </button>
    </div>
    ...
    <div className="projects-section">
      ...
      <div className="project-boxes jsGridView">
        <div className="project-box-wrapper">
          <div className="project-box" style={{/* TODO: convert to inline object */}}>
        ...
        <div className="box-progress-wrapper">
          ...
          <div className="box-progress-bar">
            <span className="box-progress" style={{/* TODO: convert to inline object */}}></span>
          </div>
          <p className="box-progress-percentage">60%</p>
        </div>
        <div className="project-box-footer">
          <div className="participants">
            <img src="/assets/illuminati7.jpg" alt="participant" />
            <img src="/assets/illuminati7.jpg" alt="participant" />
            <button className="add-participant" style={{/* TODO: convert to inline object */}}>
          ...
          <div className="days-left" style={{/* TODO: convert to inline object */}}>
            2 Days Left
          </div>
        </div>
      </div>
...
<div className="messages-section">
  ...
  <div className="messages">
    <div className="message-box">
      <img src="/assets/illuminati7.jpg" alt="profile image" />
